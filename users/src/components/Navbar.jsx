...
const Navbar = () => {
  ...
  const toggleDrawer = () => {
    ...
    setIsMenuOpen(false); // Ensure the menu button is toggled off when the drawer opens/closes
  };
              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute bg-white text-gray-600 shadow-md rounded w-60 mt-4 p-5 z-10">
                    ...
                    <Link to={`/user-Profile/MyOrder`} className="block px-4 py-2 hover:bg-gray-200">
                      My Orders
                    </Link>
                    <Link to={`/user-Profile/SaveAddress`} className="block px-4 py-2 hover:bg-gray-200">
                      Save Address
                    </Link>
                    <Link
                    ...
                    >
                      ...
                      <span className="text-sm font-thin">₹ 50</span>
                    </Link>
                    <div className="border-t my-2"></div>
                    <Link to="/faqs" className="block px-4 py-2 hover:bg-gray-200">
                      FAQ's
                    </Link>
                    <Link to="/account-privacy" className="block px-4 py-2 hover:bg-gray-200">
                      Account Privacy
                    </Link>
                    <button
